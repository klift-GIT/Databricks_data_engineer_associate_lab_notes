...
AS SELECT * FROM cloud_files("/Volumes/ccdp_nl_learning/bronze/c360/events", "csv", map("cloudFiles.inferColumnTypes", "true"))
...
AS SELECT * FROM cloud_files("/Volumes/ccdp_nl_learning/bronze/c360/orders", "json")
...
AS SELECT * FROM cloud_files("/Volumes/ccdp_nl_learning/bronze/c360/users", "json", map("cloudFiles.inferColumnTypes", "true"))
